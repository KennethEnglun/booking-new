  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white rounded-lg p-6 shadow-xl w-full max-w-sm">
        <h2 className="text-lg font-bold mb-4 text-gray-800">管理員登入</h2>
        <input
          type="password"
          value={password}
        ...
        <div className="flex justify-end space-x-2 mt-4">
          <button onClick={onCancel} className="px-4 py-2 rounded text-gray-600 hover:bg-gray-200">取消</button>
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans text-gray-800">
      ...
      <header className="bg-white/80 backdrop-blur-lg shadow-md sticky top-0 z-20 border-b border-gray-200">
